from src.utils.config import (
    ...
    YOUTUBE_GUNSHOT_AUDIO_DIR,
    SEGMENT_SECONDS,
    TARGET_SR,
    GUNSHOT_ENERGY_THRESHOLD,
    GUNSHOT_PEAK_THRESHOLD
)
...
YOUTUBE_GUNSHOT_AUDIO_DIR.mkdir(parents=True, exist_ok=True)
...
audio_files = list(YOUTUBE_GUNSHOT_VIDEO_DIR.glob("*.wav"))
...
for audio_path in tqdm(audio_files):
    ...
    for i in range(total_segments):
        ...
        if energy < GUNSHOT_ENERGY_THRESHOLD and peak < GUNSHOT_PEAK_THRESHOLD:
            continue
...
print("\n✅ Dataset GUNSHOT creado correctamente")